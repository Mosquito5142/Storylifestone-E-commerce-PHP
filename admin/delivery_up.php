            ...
            <div class="checkoutLayout">
                ...
                <div class="right">
                    ...
                    <div class="return">
                        ...
                        <br>
                        <form action="dilivery_update.php" method="post" enctype="multipart/form-data">
                        ...
                        <label class="custom-file-label" for="exampleInputFile">หลักฐานการส่งสินค้า</label>
                    </div>
                    <div class="form-group mb-4">
                        ...
                        ?>
                            ...
                            <button class="buttonCheckout bg-blue-300" type="submit">ส่งสินค้าเรียบร้อย</button>
                    </div>
                    </form>
                  </div>
            </div>
