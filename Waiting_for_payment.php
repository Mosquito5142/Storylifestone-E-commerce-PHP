            ...
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM sales_orders 
                            ...
                            AND sales_orders.order_status = 'Waiting for payment' ORDER BY so_no DESC";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a class="text-cyan-500 underline decoration-indigo-500" href="payment.php?id=<?= $row['so_no'] ?>">แจ้งชำระเงิน</a></td>
                        </tr>
                        <?php
                    }
                    ?>
