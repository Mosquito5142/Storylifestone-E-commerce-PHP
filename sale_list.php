            ...
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM sales_orders 
                            ...
                            AND sales_orders.order_status = 'Pending' ORDER BY so_no DESC";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a class="text-cyan-500 underline decoration-indigo-500" href="so_detail.php?id=<?= $row['so_no'] ?>">ข้อมูลการสั่งซื้อ</a></td>
                        </tr>
                        <?php
                    }
                    ?>
